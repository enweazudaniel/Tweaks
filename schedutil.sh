...
echo "3000" > /sys/devices/system/cpu/cpu2/cpufreq/schedutil/up_rate_limit_us
echo "3000" > /sys/devices/system/cpu/cpu0/cpufreq/schedutil/up_rate_limit_us 
...
echo "95" > /sys/devices/system/cpu/cpu2/cpufreq/schedutil/hispeed_load
